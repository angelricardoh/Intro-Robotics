...
class Run:
    def __init__(self, factory):
        ...
        self.pidTheta = pid_controller.PIDController(300, 5, 50, [-10, 10], [-300, 300], is_angle=True)
        self.pidDistance = pid_controller.PIDController(1000, 0, 50, [0, 0], [-300, 300], is_angle=False)
        self.pidWallFollow = pid_controller.PIDController(1000, 0, 100, [-75, 75], [-300, 300], is_angle=True)
        ...
        while len(waypoints) > 0:
            ...
            while self.get_dist_to_goal(goal_x, goal_y) > dist_threshold:
                ...
                while (dist_to_wall is not None and dist_to_wall <= wall_threshold
                    ...
                    self.follow_wall(dist_to_wall, goal_dist_to_wall, base_speed=self.base_speed)
